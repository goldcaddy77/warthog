...
import { MinimalModel, WhereInput } from '..';

export class MinimalService<E extends MinimalModel> {
  ...
  // W extends Partial<E>
  async update<W extends any>(data: DeepPartial<E>, where: W): Promise<E> {
  ...
  async delete<W extends any>(where: W, data: any = {}): Promise<StandardDeleteResponse> {
    data = {
      ...data,
