...
It can sometimes cause problems to explicitly require Warthog's depdendencies (ie `@nestjs/graphql`, `typedi`, `typeorm` and `typeorm-typedi-extensions`). In future versions, remove these explicit dependencies from `package.json`:
...
- Your entire GraphQL Schema including:
  - types to match your entities - generated by [TypeGraphQL](https://github.com/19majkel94/@nestjs/graphql)
...
- [TypeGraphQL](https://github.com/19majkel94/@nestjs/graphql) - GraphQL generation
